...
from gym_collision_avoidance.envs.utils.vec_env.base_vec_env import VecEnv
from gym_collision_avoidance.envs.utils.vec_env.util import copy_obs_dict, dict_to_obs, obs_space_info
