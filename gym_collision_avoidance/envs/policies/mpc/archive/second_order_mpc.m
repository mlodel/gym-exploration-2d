...
ub_R = [ +2,  +3,Inf, +50,   +50,    +1.5*pi, 1.1, 3.0];
...
for i=1:model.N
    ...
    model.ineq{i} = @(z,p) inequality_constr_scenario(z(4: 8),z(1: 3), p, i);
...
codeoptions = getOptions('SecondOrderMPCsolver');
