...
class Config:
    ...
    def __dict__(self):
        ...
        "PLOT_EVERY_N_EPISODES":self.PLOT_EVERY_N_EPISODES,
        "DT":self.DT,
        "REWARD_AT_GOAL":self.REWARD_AT_GOAL,
        "REWARD_COLLISION_WITH_AGENT":self.REWARD_COLLISION_WITH_AGENT,
        "REWARD_COLLISION_WITH_WALL":self.REWARD_COLLISION_WITH_WALL ,
        "REWARD_GETTING_CLOSE":self.REWARD_GETTING_CLOSE,
        "REWARD_ENTERED_NORM_ZONE":self.REWARD_ENTERED_NORM_ZONE,
        "REWARD_TIME_STEP":self.REWARD_TIME_STEP,
        "REWARD_DISTANCE_TO_GOAL":self.REWARD_DISTANCE_TO_GOAL,
        "REWARD_WIGGLY_BEHAVIOR":self.REWARD_WIGGLY_BEHAVIOR,
        "WIGGLY_BEHAVIOR_THRESHOLD":self.WIGGLY_BEHAVIOR_THRESHOLD,
        "COLLISION_DIST":self.COLLISION_DIST,
        "GETTING_CLOSE_RANGE":self.GETTING_CLOSE_RANGE,
        "LASERSCAN_LENGTH":self.LASERSCAN_LENGTH,
        "NUM_STEPS_IN_OBS_HISTORY":self.NUM_STEPS_IN_OBS_HISTORY,
        "NUM_PAST_ACTIONS_IN_STATE":self.NUM_PAST_ACTIONS_IN_STATE ,

        "NEAR_GOAL_THRESHOLD":self.NEAR_GOAL_THRESHOLD,
        "MAX_TIME_RATIO":self.MAX_TIME_RATIO,

        "SENSING_HORIZON":self.SENSING_HORIZON,

        "RVO_TIME_HORIZON":self.RVO_TIME_HORIZON,
        "RVO_COLLAB_COEFF":self.RVO_COLLAB_COEFF,
        "RVO_ANTI_COLLAB_T":self.RVO_ANTI_COLLAB_T,

        "MAX_NUM_AGENTS_IN_ENVIRONMENT":self.MAX_NUM_AGENTS_IN_ENVIRONMENT,
        "MAX_NUM_OTHER_AGENTS_IN_ENVIRONMENT":self.MAX_NUM_OTHER_AGENTS_IN_ENVIRONMENT,
        "MAX_NUM_OTHER_AGENTS_OBSERVED":self.MAX_NUM_OTHER_AGENTS_OBSERVED
        }